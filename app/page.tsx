    ...
    <>
      ...
      <>
        <div className="font-mono p-24">
          ...
          {/* Next part */}
          <div>
            <h1 className="font-semibold text-center text-3xl mb-12">
              Testimonials
            </h1>
            <div className="flex justify-center items-center text-center p-4 m-auto w-11/12">
              <div className="">
                <p>Ruby L.</p>
          ...
          <div>
            <h1 className="text-center text-3xl">Safety Checks</h1>
          </div>
